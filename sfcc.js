...
export default async function getProducts(searchQuery) {
  const clientConfig = {
    ...
    parameters: {
      clientId: process.env.SFDC_CLIENT_ID || "10123",
      secret: process.env.SFDC_SECRET || "10123",
      organizationId: process.env.SFDC_ORGANIZATIONID || "10123",
      shortCode: process.env.SFDC_SHORTCODE || "10123",
      siteId: process.env.SFDC_SITEID || "10123",
    },
  }
